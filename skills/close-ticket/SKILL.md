---
name: close-ticket
description: Safely complete an accepted and integrated Kotta ticket, release its claim and Git resources, and update package status. Use when a reviewed ticket has been accepted and merged or otherwise integrated.
---

# Close a ticket

Use `kotta ticket close` as the canonical completion operation. Never delete claims, branches, worktrees, or canonical ticket files by hand.
...
4. Run `kotta ticket close <ticket-id>` with the required approval, integration, and resolution inputs.
5. Verify that the ticket moved to done, the claim was released, safe worktree and local-branch cleanup occurred, the containing package was updated, and `.kotta/index.md` was regenerated.
