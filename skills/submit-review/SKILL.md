---
name: submit-review
description: Prepare evidence and submit an implemented Kotta ticket into review. Use when implementation is complete and a user or agent asks to request review, open or record a pull request, or move a ticket to review.
---

# Submit a ticket for review

Use `kotta ticket review` for the lifecycle mutation. Do not move the ticket file or edit status manually.
...
7. Run `kotta ticket review <ticket-id>` with supported evidence and pull-request options; use `--json` for automation.
