...
const data = workspace({
  contracts: [
    ...
    contract("T-012", "Make the UI workspace argument explicit", { status: "active", batch: "P-003", assigned_agent: "codex" }),
...
describe("Observations", () => {
  it("carries the design's step, wording and disk note", () => {
    ...
    expect(screen.getByText(/stored as/).textContent).toContain("observation");
    expect(screen.getByText(".kotta/observations/")).toBeDefined();
  });
